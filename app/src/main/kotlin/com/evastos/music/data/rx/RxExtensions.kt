...
fun <T> Single<T>.checkNetwork(networkConnectivityProvider: NetworkConnectivityProvider): Single<T> {
    return Single.just(networkConnectivityProvider.isConnected())
            .flatMap { it ->
                if (it) {
                    this
                } else {
